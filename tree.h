...
void printHuffmanEncoding( TNode* root, char c ); //TO DO FUNCTION CALLED HERE
...
void insertSegment( TNode* root, double segmentStart, double segmentEnd ); //TO DO FUNCTION CALLED HERE
